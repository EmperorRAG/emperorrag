...
- Include `description` (single sentence, actionable outcome), `agent` (explicitly choose `ask`, `edit`, or `agent`), and `tools` (minimal set of tool bundles required to fulfill the prompt).
