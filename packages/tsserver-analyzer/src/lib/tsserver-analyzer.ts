...
import {
  ...
  processEvent,
  reset,
} from "./core/trace/analyzer/trace-analyzer.service.js";
import type {
  PerformanceStat,
  SlowOperation,
} from "./core/trace/analyzer/trace-analyzer.types.js";
...
export const TraceAnalyzer = Context.GenericTag<TraceAnalyzer>(
  "@emperorrag/tsserver-analyzer/TraceAnalyzer",
);
  ...
  Effect.gen(function* (_) {
    ...
    return {
      processEvent: (event: TraceEvent) =>
        Ref.update(stateRef, (state) => processEvent(event)(state)),
