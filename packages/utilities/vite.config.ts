  ...
  build: {
    ...
    lib: {
      ...
      entry: {
        ...
        "lib/helper-functions/helperFunctions":
          "./src/lib/helper-functions/helperFunctions.ts",
        "lib/types/types": "./src/lib/types/types.ts",
        "lib/helper-functions/object.utils":
          "./src/lib/helper-functions/object.utils.ts",
      },
