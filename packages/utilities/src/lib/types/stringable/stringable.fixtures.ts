...
export const getAllPrimitiveInputLabelExpectedObjects = () =>
	mergeObjects(mergeObjects(toInputObjects(getAllPrimitiveValues()))(toLabelObjects(getAllPrimitiveLabelValues())))(
...
export const getAllFunctionInputLabelExpectedObjects = () =>
	mergeObjects(mergeObjects(toInputObjects(getAllFunctionValues()))(toLabelObjects(getAllFunctionLabelValues())))(
...
export const getAllObjectInputLabelExpectedObjects = () =>
	mergeObjects(mergeObjects(toInputObjects(getAllObjectValues()))(toLabelObjects(getAllObjectLabelValues())))(
