...
See [Product Vision](../vision/product-vision.md) for the complete vision statement, strategic pillars, and success metrics.
...
This PRD covers the following initiatives from the [Product Roadmap](../roadmap/product-roadmap.md):
