...
export default defineConfig(() => ({
  ...
  plugins: [
    nxCopyAssetsPlugin(["README.md", "package.json"]),
    dts({
      entryRoot: "./src",
  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        "lib/client/core/email/change-password/changePassword":
          "./src/lib/client/core/email/change-password/changePassword.ts",
        "lib/server/core/email/change-password/changePassword":
          "./src/lib/server/core/email/change-password/changePassword.ts",
        ...
        "lib/server/core/email/forget-password/forgetPassword":
          "./src/lib/server/core/email/forget-password/forgetPassword.ts",
        "lib/client/core/email/reset-password/resetPassword":
          "./src/lib/client/core/email/reset-password/resetPassword.ts",
        "lib/server/core/email/reset-password/resetPassword":
          "./src/lib/server/core/email/reset-password/resetPassword.ts",
        ...
        "lib/client/core/account/list-accounts/listAccounts":
          "./src/lib/client/core/account/list-accounts/listAccounts.ts",
        "lib/server/core/account/list-user-accounts/listUserAccounts":
          "./src/lib/server/core/account/list-user-accounts/listUserAccounts.ts",
        "lib/client/core/account/unlink-account/unlinkAccount":
          "./src/lib/client/core/account/unlink-account/unlinkAccount.ts",
        "lib/server/core/account/unlink-account/unlinkAccount":
          "./src/lib/server/core/account/unlink-account/unlinkAccount.ts",
        ...
        "lib/server/core/oauth/sign-in-social/signInSocial":
          "./src/lib/server/core/oauth/sign-in-social/signInSocial.ts",
        ...
        "lib/server/core/oauth/callback-oauth/callbackOAuth":
          "./src/lib/server/core/oauth/callback-oauth/callbackOAuth.ts",
        "lib/server/core/oauth/link-social-account/linkSocialAccount":
          "./src/lib/server/core/oauth/link-social-account/linkSocialAccount.ts",
        "lib/server/core/session/list-sessions/listSessions":
          "./src/lib/server/core/session/list-sessions/listSessions.ts",
        "lib/server/core/session/get-access-token/getAccessToken":
          "./src/lib/server/core/session/get-access-token/getAccessToken.ts",
        "lib/server/core/session/refresh-token/refreshToken":
          "./src/lib/server/core/session/refresh-token/refreshToken.ts",
        "lib/server/core/session/revoke-session/revokeSession":
          "./src/lib/server/core/session/revoke-session/revokeSession.ts",
        "lib/server/core/session/revoke-sessions/revokeSessions":
          "./src/lib/server/core/session/revoke-sessions/revokeSessions.ts",
        ...
        "lib/server/core/user/delete-user-callback/deleteUserCallback":
          "./src/lib/server/core/user/delete-user-callback/deleteUserCallback.ts",
        // Pipeline modules
        ...
        "lib/pipeline/extract-auth-server-config/extractAuthServerConfig":
          "./src/lib/pipeline/extract-auth-server-config/extractAuthServerConfig.ts",
