...
import type { SessionAuthServerError } from '../shared/session.error.js';
 ...
 */
export type GetSessionServerInput<T extends AuthServerFor<ReturnType<typeof betterAuth>> = AuthServerFor<ReturnType<typeof betterAuth>>> =
	Parameters<
 ...
 */
export type GetSessionServerResult<T extends AuthServerFor<ReturnType<typeof betterAuth>> = AuthServerFor<ReturnType<typeof betterAuth>>> =
	ReturnType<
		'getSession' extends keyof T['api'] ? (T['api']['getSession'] extends (...args: any) => any ? T['api']['getSession'] : never) : never
	>;
