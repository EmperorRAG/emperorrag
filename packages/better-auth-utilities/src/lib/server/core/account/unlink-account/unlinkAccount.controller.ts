...
import { createAuthSchema, providerIdBodySchema } from '../../../../pipeline/zod-schema-builder/zodSchemaBuilder';
...
export const unlinkAccountServerController: unlinkAccountPropsFor = (params: AuthServerApiUnlinkAccountParamsFor<AuthServerFor>) =>
	Effect.gen(function* () {
		const validatedParams = yield* validateInputEffect(
			createAuthSchema({ body: providerIdBodySchema, headers: 'optional' }),
			params,
