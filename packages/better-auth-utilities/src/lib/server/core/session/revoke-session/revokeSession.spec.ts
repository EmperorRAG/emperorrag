/**
 * @file libs/better-auth-utilities/src/lib/server/core/session/revoke-session/revokeSession.spec.ts
 * @description Tests for server-side revoke session operation.
 */
