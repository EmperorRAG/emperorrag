/**
 * @file libs/better-auth-utilities/src/lib/server/core/email/send-verification-email/sendVerificationEmail.service.ts
...
import type { SendVerificationEmailServerParams } from "./sendVerificationEmail.types";
