...
import {
  type AuthServerApiSignOutParamsFor,
  isAuthServerApiSignOutParamsFor,
  type signOutPropsFor,
} from "./signOut.types";

export const signOutServerController: signOutPropsFor = (
  ...
  Effect.gen(function*() {
    ...
    )(isAuthServerApiSignOutParamsFor)(params);
