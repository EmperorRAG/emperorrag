...
export type AuthServerApiForgetPasswordCallbackPropsFor<
...
export type AuthServerApiForgetPasswordCallbackParamsFor<
  T extends AuthServerFor = AuthServerFor,
> = Parameters<AuthServerApiForgetPasswordCallbackPropsFor<T>>[0];

export type AuthServerApiForgetPasswordCallbackResultFor<
  T extends AuthServerFor = AuthServerFor,
> = ReturnType<AuthServerApiForgetPasswordCallbackPropsFor<T>>;

export interface forgetPasswordCallbackPropsFor<
  T extends AuthServerFor = AuthServerFor,
> {
  (
