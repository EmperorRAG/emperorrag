...
import type { AdapterConfig } from '../base/plugin-adapter.interface.ts';
import { GenericOAuthAdapter } from './generic-oauth.adapter.js';
import { GenericOAuthService } from './generic-oauth-nestjs.service.js';
